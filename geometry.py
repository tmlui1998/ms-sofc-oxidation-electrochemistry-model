...
from parameters import (
    ...
    rib_w, channel_w,
    Lx, Ly,
    h_fuel_channel, h_metal_support, h_afl, h_electrolyte, h_cfl, h_cathode, h_air_channel,
    z0, z_fuel_top, z_ms_top, z_afl_top, z_elyte_top, z_cfl_top, z_cathode_top, z_air_top, mesh_size,
)
